...
export const FACTORY_SESSIONS = Object.freeze([
  {
    ...
    tracks: [
      { name: "Far choir", patchId: "factory-patch-slow-sky", gain: 0.78, pan: -0.16, useHarmonicGuide: true,
        anchors: anchors([0, -118, 7.2], [32, -42, 8.2], [64, 52, 6.8]), regions: [region(0, 64, 701101)] },
      { name: "Glass signals", patchId: "factory-patch-glass-canopy", gain: 0.62, pan: 0.20, useHarmonicGuide: true,
        anchors: anchors([0, 78, 4.4], [32, 138, 6.4], [64, -124, 5.2]), regions: [region(8, 48, 701102)] },
      { name: "Morning flute", patchId: "factory-patch-wandering-flute", gain: 0.72, pan: 0.08, useHarmonicGuide: true,
  ...
  },
  {
    ...
    tracks: [
      { name: "Membrane floor", patchId: "factory-patch-cave-bloom", gain: 0.84, pan: 0, useHarmonicGuide: true,
        anchors: anchors([0, 136, 4.8], [32, 168, 6.8], [64, -146, 5.5]), regions: [region(0, 64, 702101)] },
      { name: "Brass wall", patchId: "factory-patch-smoke-drift", gain: 0.72, pan: -0.24, useHarmonicGuide: true,
        anchors: anchors([0, -74, 7.6], [32, -128, 6.3], [64, -32, 8.5]), regions: [region(4, 56, 702102)] },
      { name: "Breath echoes", patchId: "factory-patch-breath-dust", gain: 0.56, pan: 0.30, useHarmonicGuide: true,
  ...
  },
  {
    ...
    tracks: [
      { name: "Orbit membrane", patchId: "factory-patch-membrane-orbit", gain: 0.82, pan: -0.12, useHarmonicGuide: true,
        anchors: anchors([0, -142, 3.8], [16, -38, 4.6], [32, 72, 5.4], [48, 152, 4.0], [64, -142, 3.8]), regions: [region(0, 64, 703101)] },
      { name: "Seven-open wind", patchId: "factory-patch-seven-open", gain: 0.70, pan: 0.18, useHarmonicGuide: true,
        anchors: anchors([0, 24, 3.2], [32, 94, 2.4], [64, -22, 3.6]), regions: [region(0, 64, 703102)] },
      { name: "Glass clock", patchId: "factory-patch-glass-clock", gain: 0.54, pan: 0.26, useHarmonicGuide: true,
  ...
  },
  {
    ...
    tracks: [
      { name: "Wood pulse", patchId: "factory-patch-wooden-pulse", gain: 0.80, pan: -0.25, useHarmonicGuide: true,
        anchors: anchors([0, -40, 2.0], [32, -72, 2.6], [64, -40, 2.0]), regions: [region(0, 64, 704101)] },
      { name: "Low anchor", patchId: "factory-patch-deep-walker", gain: 0.90, pan: -0.14, useHarmonicGuide: true,
        anchors: anchors([0, -112, 3.6], [32, -132, 4.2], [64, -112, 3.6]), regions: [region(0, 64, 704102)] },
      { name: "Velvet hook", patchId: "factory-patch-velvet-hook", gain: 0.72, pan: 0.12, useHarmonicGuide: true,
        anchors: anchors([0, 34, 2.4], [32, 74, 2.9], [64, 34, 2.4]), regions: [region(8, 56, 704103)] },
      { name: "Silver answer", patchId: "factory-patch-silver-answer", gain: 0.64, pan: 0.30, useHarmonicGuide: true,
  ...
  },
  {
    ...
    tracks: [
      { name: "Low transit", patchId: "factory-patch-deep-walker", gain: 0.88, pan: -0.10, useHarmonicGuide: true,
        anchors: anchors([0, -82, 2.8], [32, -126, 3.6], [64, -82, 2.8]), regions: [region(0, 64, 705101)] },
      { name: "Broken keys", patchId: "factory-patch-broken-keys", gain: 0.74, pan: 0.20, useHarmonicGuide: true,
        anchors: anchors([0, 66, 2.5], [32, 152, 4.6], [64, 46, 3.0]), regions: [region(4, 60, 705102)] },
      { name: "Vocal carriage", patchId: "factory-patch-wandering-mouth", gain: 0.66, pan: -0.20, useHarmonicGuide: true,
        anchors: anchors([0, 156, 5.6], [32, 98, 4.0], [64, -166, 5.0]), regions: [region(12, 48, 705103)] },
      { name: "Rim lights", patchId: "factory-patch-rim-logic", gain: 0.50, pan: 0.28, useHarmonicGuide: true,
