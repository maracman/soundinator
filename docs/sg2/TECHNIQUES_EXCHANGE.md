...
### T-064 · ENGINE LAW SPEC (Agent A): held strike/pluck = free decay, note-off = damper contact
...
### T-065 · ENGINE SPEC (Agent A): pinned pre-onset components carry independent envelopes
...
### T-066 · ENGINE SPEC (Agent A): pinned envelope-deviation classes
