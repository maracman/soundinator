...
def band_balance_distance(ref: FeatureBundle, render: FeatureBundle) -> dict[str, Any]:
...
def compare_features(ref: FeatureBundle, render: FeatureBundle, weights: dict[str, float] | None = None) -> dict[str, Any]:
    ...
    band_balance = band_balance_distance(ref, render)
    values = {
        ...
        "band_balance_db": float(band_balance["meanDb"] or 0.0),
    }
