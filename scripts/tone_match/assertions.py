...
from .score import FeatureBundle, OCTAVE_CENTRES, THIRD_OCTAVE_CENTRES, band_balance_distance
...
ALIASES = {
    ...
    "grand piano": "piano", "acoustic guitar": "guitar", "classical guitar": "guitar",
    ...
    if FAMILY.get(name) == "blown":
        ...
        for sample in sample_list:
            if sample.reference is None:
                continue
            distance = band_balance_distance(sample.reference, sample.render)
